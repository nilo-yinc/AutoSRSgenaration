        ...
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="absolute top-4 right-4 z-50">
                <button
                    ...
                    className="px-4 py-2 bg-red-900/50 text-red-400 border border-red-900/50 rounded-lg hover:bg-red-900 hover:text-white transition text-sm"
                >
                    Logout
                </button>
            </div>
            ...
            >
                <h2 className="text-4xl font-bold text-gray-400 group-hover:text-neon-blue mb-4 transition-colors">Enterprise SRS</h2>
                ...
                <button className="mt-8 px-6 py-2 border border-neon-blue/50 text-neon-blue rounded hover:bg-neon-blue/10 transition">
                    Access Module
                </button>
            </motion.div>
